...
#import "AddPurposeViewController.h"

@interface AddPurposeViewController ()

@end

@implementation AddPurposeViewController
...
-(IBAction)add:(id)sender{
    if([self checkTextView]){
        [[NSNotificationCenter defaultCenter]postNotificationName:@"purposeInsert" object:nil userInfo:@{@"purpose":textView.text}];
